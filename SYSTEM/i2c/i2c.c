...
void IIC_Byte_Write( IIC_Typedef iic_x, u8 Device_Address, u8 pBuffer, u8 Word_Address)
{
	if(iic_x==IIC_LED)
	{
...
void IIC_Wait_Nobusy( IIC_Typedef iic_x, u8 Device_Address)
{
	if(iic_x==IIC_LED)
	{
						vu16 SR1_Tmp = 0;
...
void IIC_Byte_Read(  IIC_Typedef iic_x, u8 Device_Address, u8* pRead, u8 Word_Address)
{
	if(iic_x==IIC_LED)
	{
